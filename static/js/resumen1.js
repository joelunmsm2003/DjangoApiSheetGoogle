...
$(window).scroll(function() {
    ...
    console.log('$(document).height()',$(document).height())
        ...
        console.log('scrol',$(document).scrollTop())
        console.log('pantalla',$(window).height())

        

        i=parseInt(numi)
        
        $scope.agregar.numi = i 
       ...
       for (j in data){
        ...
        console.log('conteo',ObjectLength($scope.clientes))

        console.log('count',$scope.contador)
        ...
        $('.loader').hide()
        $( "#tablee" ).show()
        $( "#tablee" ).addClass("animated bounce");
    ...
    $scope.Buscar = function(currentPage)
    {
        ...
        $('.loader').hide()
        $( "#tablee" ).show()
        //$( "#tablee" ).addClass("animated pulse");
